...
public class SlayerESP {
    ...
    static Entity defaultmobseman;
    static Entity defaultmobsspider;
    static Entity defaultmobswolf;
    ...
    public void onWorldChange(WorldEvent.Load event) {
        ...
        wolf = null;
        enderman = null;
        defaultmobseman = null;
        defaultmobsspider = null;
        defaultmobswolf = null;
    }
    ...
    public void onTick(TickEvent.ClientTickEvent event) {
        ...
        if (zombie != null || spider != null || wolf != null || enderman != null || defaultmobseman != null || defaultmobsspider != null || defaultmobswolf != null) {
            return;
        }
        slayerActive = true;
                ...
                if (cleanedLine.contains("Slay the boss!")) {
                    ...
                    for (Entity e : entities) {
                        ...
                        if (e.getName().contains("Tarantula Broodfather")) {
                            ...
                            enderman = e;
                            return;
                        } else if (e.getName().contains("Enderman") || e.getName().contains("Zealot") || e.getName().contains("Voidling Fanatic") || e.getName().contains("Voidling Extremist") || e.getName().contains("Voidling Devotee") || e.getName().contains("Voidling Radical") || e.getName().contains("Voidcrazed Maniac")) {
                            defaultmobseman = e;
                            return;
                        } else if (e.getName().contains("Splitter Spider") || e.getName().contains("Weaver Spider") || e.getName().contains("Voracious Spider") || e.getName().contains("Spider Jockey") || e.getName().contains("Dasher Spider") || e.getName().contains("Brood Mother") || e.getName().contains("Spider") || e.getName().contains("Tarantula Beast") || e.getName().contains("Mutant Tarantula") || e.getName().contains("Tarantula Vermin")) {
                            defaultmobsspider = e;
                            return;
                        } else if (e.getName().contains("Wolf") || e.getName().contains("Old Wolf") || e.getName().contains("Pack Spirit") || e.getName().contains("Soul of the Alpha") || e.getName().contains("Howling Spirit") || e.getName().contains("Pack Enforcer") || e.getName().contains("Sven Follower") || e.getName().contains("Sven Alpha")) {
                            defaultmobswolf = e;
                            return;
                        }
                    }
