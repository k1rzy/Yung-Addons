...
public class GemstoneESP {
    ...
    public static BlockPos ruby;
    public static BlockPos amber;
    public static BlockPos jasper;
    public static BlockPos topaz;
    public static BlockPos jade;
    public static BlockPos sapphire;
    public static BlockPos amethyst;

    @SubscribeEvent
    public void Ruby(RenderWorldLastEvent event) throws NullPointerException {
        Minecraft mc = Minecraft.getMinecraft();
        if(Config.gemesp && mc.getCurrentServerData().serverIP.contains("hypixel.")) {
            ruby = closestGemstone();
                try {
                    if (ruby != null)
                        RenderUtils.drawBlockBox(ruby, Config.ESPColorgem, true, event.partialTicks);
                }
