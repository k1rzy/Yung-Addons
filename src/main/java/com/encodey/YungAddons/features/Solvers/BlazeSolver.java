                                        ...
                                        if (lowestBlaze != null) {
                                            for(Entity Lowest : world.loadedEntityList)
                                                if(Lowest instanceof EntityBlaze) {
                                                    ...
                                                    if(setPositionLowest) {
                                                        Lowest.setPosition(lowestBlaze.posX, lowestBlaze.posY, lowestBlaze.posZ);
                                                        setPositionLowest = false;
                                                    }
                                                    if (dist < radius) {
                                        ...
                                        if (highestBlaze != null) {
                                            for (Entity Highest : world.loadedEntityList)
                                                if (Highest instanceof EntityBlaze) {
                                                    ...
                                                    if(setPositionHighest) {
                                                        Highest.setPosition(highestBlaze.posX, highestBlaze.posY, highestBlaze.posZ);
                                                        setPositionHighest = false;
                                                    }
                                                    if (dist < radius) {
