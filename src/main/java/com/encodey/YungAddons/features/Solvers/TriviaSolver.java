...
public class TriviaSolver {
    ...
    public static void init() {
        ...
        triviaSolutions.put("How many total Fairy Souls are there?", new String[]{"228 Fairy Souls"});
        ...
        triviaSolutions.put("How many Fairy Souls are there in Mushroom Desert?", new String[]{"13 Fairy Souls"});
            ...
            if (triviaAnswers != null && (message.contains("ⓐ") || message.contains("ⓑ") || message.contains("ⓒ"))) {
                ...
                for (String solution : triviaAnswers) {
                    if (message.contains(solution)) {
                        Minecraft.getMinecraft().thePlayer.addChatMessage(new ChatComponentText(EnumChatFormatting.RED + "[Yung Addons] " + EnumChatFormatting.GREEN + solution));
                        isSolution = true;
                        break;
                    }
                }
