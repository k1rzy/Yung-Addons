...
import com.encodey.YungAddons.utils.MathUtils.IceWalkUtils;
...
public class IceFillSolver {
    ...
    public static int ICE_WALK_LINE_COLOUR = 0x00;
    ...
    public void onTick(TickEvent.ClientTickEvent event) {
        ...
        World world = mc.theWorld;
            if (Config.icefillsolver && DungeonChestESP.dungeonStarted && world != null && player != null) {
    ...
    public void onWorldRender(RenderWorldLastEvent event) {
        if (Config.icefillsolver && DungeonChestESP.dungeonStarted && chest != null) {
            if (threeByThreeRoute != null && threeByThreeRoute.size() > 1) {
                for (int i = 0; i < threeByThreeRoute.size() - 1; i++) {
                    ...
                    UtilsDanker.draw3DLine(pos1, pos2, ICE_WALK_LINE_COLOUR, 5, true, event.partialTicks);
                }
            }
