...
/*
    ...
    public void onTick(TickEvent.ClientTickEvent event) {
        ...
        World world = mc.theWorld;
            if (Config.waterboardsolver && DungeonChestESP.dungeonStarted && world != null && player != null) {
                                    ...
                                    if (!prevInWaterRoom) {
                                        ...
                                        switch (variant) {
                                            ...
                                            case 4:
                                                ...
                                                break;
                                            default:
                                                purple = orange = blue = green = red = EnumChatFormatting.RED + "Error detecting water puzzle variant.";
                                                break;
                                        }
                                        waterAnswers = EnumChatFormatting.GREEN + "" +
    ...
    public void renderPlayerInfo(RenderOverlay event) {
        if (Config.waterboardsolver && DungeonChestESP.dungeonStarted && waterAnswers != null) {
