...
public class SuperpairsSolver {
    ...
    public void onTooltip(ItemTooltipEvent event) {
        ...
        if (mc.currentScreen instanceof GuiChest) {
            ...
            if (Config.expersolver && chestName.contains("Superpairs (")) {
    ...
    public void onTick(TickEvent.ClientTickEvent event) {
        ...
        if (mc.currentScreen instanceof GuiChest) {
            ...
            if (Config.expersolver && chestName.startsWith("Superpairs (")) {
                for (int i = 0; i < 53; i++) {
    ...
    public void onGuiRender(ChestGui event) {
        if (Config.expersolver && event.displayName.contains("Superpairs (")) {
            ...
            matches.forEach((itemName, slotSet) -> {
                ...
                slots.forEach(slot -> {
                    UtilsDanker.drawOnSlot(event.chestSize, slot.xDisplayPosition, slot.yDisplayPosition, color.getRGB());
                });
            });
        }
    }
