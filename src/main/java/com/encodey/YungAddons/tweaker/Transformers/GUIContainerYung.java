...
import com.encodey.YungAddons.tweaker.Transformers.TransformerClass;
import com.encodey.YungAddons.tweaker.Transformers.TransformerMethod;
...
public class GUIContainerYung implements ITransformer {
    /**
                ...
                while (iterator.hasNext()) {
                    ...
                    if (abstractNode instanceof MethodInsnNode && abstractNode.getOpcode() == Opcodes.INVOKESPECIAL) {
                        ...
                        if (methodInsnNode.owner.equals(TransformerClass.GuiContainer.getNameRaw()) && TransformerMethod.drawSlot.matches(methodInsnNode)) {
                            methodNode.instructions.insert(abstractNode, new MethodInsnNode(Opcodes.INVOKESTATIC, "com/encodey/YungAddons/tweaker/hooks/GuiContainerHook",
