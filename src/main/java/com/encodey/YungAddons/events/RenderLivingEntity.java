...
@Cancelable
public class RenderLivingEntity extends Event {

    public EntityLivingBase entity;
    public float p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, scaleFactor;
    public ModelBase modelBase;

    public RenderLivingEntity(EntityLivingBase entity, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float scaleFactor, ModelBase modelBase) {
        this.entity = entity;
