...
public class Config extends Vigilant{
    ...
    @Property(
            ...
            description = "Enables enderman ESP when slayer spawning"
    )
    ...
    @Property(
            ...
            description = "Enables spider ESP when slayer spawning"
    )
    ...
    @Property(
            ...
            description = "Enables wolf ESP when slayer spawning"
    )
    ...
    @Property(
            ...
            name = "Gemstone ESP",
            description = "Shows stained glass ESP"
    )
