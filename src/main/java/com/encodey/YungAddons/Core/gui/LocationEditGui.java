...
public class LocationEditGui extends GuiScreen {
        ...
        public void initGui() {
            ...
            String displayNums = EnumChatFormatting.GOLD + "1,024" + "\n" +
                    ...
                    EnumChatFormatting.AQUA + UtilsDanker.getTimeBetween(0, 2678400) + "\n" +
            ...
            String dungeonTimerNums = EnumChatFormatting.GRAY + "" + 5 + "\n" +
                    EnumChatFormatting.DARK_RED + UtilsDanker.getTimeBetween(0, 33) + "\n" +
                    EnumChatFormatting.RED + UtilsDanker.getTimeBetween(0, 129) + "\n" +
                    EnumChatFormatting.BLUE + UtilsDanker.getTimeBetween(0, 169) + "\n" +
