...
{
    public static final char[] modMessageChars = "YungAddons".toCharArray();
    public static float posX;
    public static float posY;
    public static final int[] CHAR_WIDTH = new int[256];;
    public static final ResourceLocation ascii = new ResourceLocation("textures/font/ascii.png");;
    ...
    public static void drawRainbowText(final String input, final float x, final float y) {
        Minecraft.getMinecraft().renderEngine.bindTexture(FontUtils.ascii);
        FontUtils.posX = x;
        FontUtils.posY = y;
    ...
    public static void drawChromaString(final String text, final int x, final int y, final int offset) {
        ...
        for (final char tc : text.toCharArray()) {
            ...
            fr.drawString(tmp, (float)(int)tmpX, (float)y, i, true);
            tmpX += fr.getCharWidth(tc);
        }
    }
